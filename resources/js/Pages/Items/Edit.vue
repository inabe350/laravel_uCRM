                                ...
                                <div class="container px-5 py-24 mx-auto">
                                    <div class="lg:w-1/2 md:w-2/3 mx-auto">
                                        <div class="flex flex-wrap -m-2">
                                            ...
                                            <div class="p-2 w-full">
                                                <div class="relative">
                                                    <InputError v-if="errors.price">{{ errors.price }}</InputError><br>
                                            ...
                                            <div class="p-2 w-full">
                                                <div class="relative">
                                                    ...
                                                    <input type="radio" id="is_selling_1" name="is_selling_0" v-model="form.is_selling" value="1">
                                                    <label for="is_selling_1" class="ml-2 mr-4">販売中</label>
                                                    <input type="radio" id="is_selling_0" name="is_selling_0" v-model="form.is_selling" value="0">
                                                    <label for="is_selling_0" class="ml-2 mr-4">停止中</label>
                                                </div>
                                            </div>
        
                                            <div class="p-2 w-full">
                                                <button tton class="flex mx-auto text-white bg-indigo-500 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded text-lg">更新する</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
